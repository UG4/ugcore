...
#ifndef __H__UG__LIB_DISC__AMG_SOLVER__AMG_BASE_IMPL_H__
#define __H__UG__LIB_DISC__AMG_SOLVER__AMG_BASE_IMPL_H__
...
#endif //  __H__UG__LIB_DISC__AMG_SOLVER__AMG_BASE_IMPL_H__
