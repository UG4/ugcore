...
Definition of PROFILE_END has been added for SHINY_PROFILER == FALSE
Missing namespace specifier has been added to the definition of
PROFILER_UPDATE for SHINY_PROFILER == FALSE.
*/
...
#define PROFILER_UPDATE					Shiny::DummyUpdate	//	Shiny:: added by Sebastian Reiter (s.b.reiter@googlemail.com)
#define PROFILER_OUTPUT					Shiny::DummyOutput	//	Shiny:: added by Sebastian Reiter (s.b.reiter@googlemail.com)
#define PROFILER_OUTPUT_TREE_STRING()	std::string()
#define PROFILER_OUTPUT_FLAT_STRING()	std::string()
#define PROFILER_DESTROY()
#define PROFILE_BEGIN(name)
#define PROFILE_END()					//	added by Sebastian Reiter (s.b.reiter@googlemail.com)
#define PROFILE_BLOCK(name)
#define PROFILE_FUNC()
