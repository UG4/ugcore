...
static void RegisterDegeneratedLayerManager(Registry& reg, string grp)
{
	...
	reg.add_class_<T>(name, grp)
		...
		.add_method("contains", static_cast<bool (T::*) (int) const>(&T::contains), "Is subset registered in the manager", "subset(s)")
		.add_method("num_subsets", static_cast<size_t (T::*) () const>(&T::num_subsets), "Number of subsets in the manager", "")
		.add_method("subset", static_cast<int (T::*) (size_t) const>(&T::subset), "Subset index for a given index in the manager", "index in the manager")
