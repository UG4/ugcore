...
//	VTK Output
	{
		...
		reg.add_class_<T>(name, grp)
			...
			.add_method("select_nodal", static_cast<void (T::*)(SmartPtr<IPData<number, dim> >, const char*)>(&T::select_nodal))
			.add_method("select_nodal", static_cast<void (T::*)(SmartPtr<IPData<MathVector<dim>, dim> >, const char*)>(&T::select_nodal))
			.add_method("select_element", static_cast<void (T::*)(const char*, const char*)>(&T::select_element))
			.add_method("select_element", static_cast<void (T::*)(SmartPtr<IPData<number, dim> >, const char*)>(&T::select_element))
			.add_method("select_element", static_cast<void (T::*)(SmartPtr<IPData<MathVector<dim>, dim> >, const char*)>(&T::select_element))
			.set_construct_as_smart_pointer(true);
