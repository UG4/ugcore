...
//	VTK Output
	{
		...
		reg.add_class_<T>(name, grp)
			...
			.add_method("select", static_cast<void (T::*)(SmartPtr<UserData<MathMatrix<dim,dim>, dim> >, const char*)>(&T::select))
			...
			.add_method("select_nodal", static_cast<void (T::*)(SmartPtr<UserData<MathMatrix<dim,dim>, dim> >, const char*)>(&T::select_nodal))
			...
			.add_method("select_element", static_cast<void (T::*)(SmartPtr<UserData<MathMatrix<dim,dim>, dim> >, const char*)>(&T::select_element))
