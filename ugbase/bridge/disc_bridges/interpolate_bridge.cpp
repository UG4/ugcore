...
//	Interpolate
...
#ifdef UG_PARALLEL
	{
		...
		reg.add_function("Interpolate", static_cast<void (*)(SmartPtr<TFct>, SmartPtr<TFct>, const char*, number)>(&ug::Interpolate<TFct>),grp, "Integral", "Data#GridFunction#Component#MoveVector");
