...
#ifndef __H__LIB_DISCRETIZATION__SPATIAL_DISCRETIZATION__DISC_HELPER__FVGEOM__
#define __H__LIB_DISCRETIZATION__SPATIAL_DISCRETIZATION__DISC_HELPER__FVGEOM__
	...
	public:
		...
		inline bool update_global(const FVElementGeometry<TElem, TWorldDim>& geo, MathVector<world_dim> corners[])
		{
			...
			else if(dim == 1 && world_dim == 2)
			{
				m_normal = corners[1];
				m_normal -= corners[0];
				// TODO: Should be * 1./2. (think about this)
...
#endif /* __H__LIB_DISCRETIZATION__SPATIAL_DISCRETIZATION__DISC_HELPER__FVGEOM__ */
