/*
 * density_driven_flow_assemble_impl.h
 *
 *  Created on: 26.02.2010
 *      Author: andreasvogel
 */

#ifndef __H__LIB_DISCRETIZATION__SPATIAL_DISCRETIZATION__COUPLED_ELEM_DISC__DENSITY_DRIVEN_FLOW__CPL_DENSITY_DRIVEN_FLOW_ASSEMBLE_IMPL__
#define __H__LIB_DISCRETIZATION__SPATIAL_DISCRETIZATION__COUPLED_ELEM_DISC__DENSITY_DRIVEN_FLOW__CPL_DENSITY_DRIVEN_FLOW_ASSEMBLE_IMPL__
...
#endif /*__H__LIB_DISCRETIZATION__SPATIAL_DISCRETIZATION__COUPLED_ELEM_DISC__DENSITY_DRIVEN_FLOW__CPL_DENSITY_DRIVEN_FLOW_ASSEMBLE_IMPL__*/
