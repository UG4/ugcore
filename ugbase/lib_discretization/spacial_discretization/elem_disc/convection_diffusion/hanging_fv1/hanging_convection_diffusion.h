/*
 * hanging_convection_diffusion.h
 *
 *  Created on: 26.02.2010
 *      Author: andreasvogel
 */

#ifndef __H__LIB_DISCRETIZATION__SPACIAL_DISCRETIZATION__ELEM_DISC__CONVECTION_DIFFUSION__HANGING_FV1__HANGING_CONVECTION_DIFFUSION__
#define __H__LIB_DISCRETIZATION__SPACIAL_DISCRETIZATION__ELEM_DISC__CONVECTION_DIFFUSION__HANGING_FV1__HANGING_CONVECTION_DIFFUSION__
...
#include "lib_discretization/spacial_discretization/disc_helper/hanging_finite_volume_geometry.h"
...
class HangingConvectionDiffusionElemDisc : public IElemDisc<TAlgebra>
{
	public:
		// domain type
	...
	private:
		...
		{
			register_prepare_element_loop_function(	id, &HangingConvectionDiffusionElemDisc::template prepare_element_loop<TElem>);
			register_prepare_element_function(		id, &HangingConvectionDiffusionElemDisc::template prepare_element<TElem>);
			register_finish_element_loop_function(	id, &HangingConvectionDiffusionElemDisc::template finish_element_loop<TElem>);
			register_assemble_JA_function(			id, &HangingConvectionDiffusionElemDisc::template assemble_JA<TElem>);
			register_assemble_JM_function(			id, &HangingConvectionDiffusionElemDisc::template assemble_JM<TElem>);
			register_assemble_A_function(			id, &HangingConvectionDiffusionElemDisc::template assemble_A<TElem>);
			register_assemble_M_function(			id, &HangingConvectionDiffusionElemDisc::template assemble_M<TElem>);
			register_assemble_f_function(			id, &HangingConvectionDiffusionElemDisc::template assemble_f<TElem>);
		}
...
#include "hanging_convection_diffusion_impl.h"

#endif /*__H__LIB_DISCRETIZATION__SPACIAL_DISCRETIZATION__ELEM_DISC__CONVECTION_DIFFUSION__HANGING_FV1__HANGING_CONVECTION_DIFFUSION__*/
