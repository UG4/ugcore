...
template <>
class GaussQuadrature<ReferenceHexahedron, 10> : public GaussQuadrature<ReferenceHexahedron, 11>{};

template <>
class GaussQuadrature<ReferenceHexahedron, 6> : public GaussQuadrature<ReferenceHexahedron, 7>{};

template <>
class GaussQuadrature<ReferenceHexahedron, 4> : public GaussQuadrature<ReferenceHexahedron, 5>{};

template <>
class GaussQuadrature<ReferenceHexahedron, 1> : public GaussQuadrature<ReferenceHexahedron, 2>{};

template <>
class GaussQuadrature<ReferenceHexahedron, 0> : public GaussQuadrature<ReferenceHexahedron, 1>{};
