...
void RegisterConstantEquationObjects(Registry& reg, const char* parentGroup)
{
//	typedef domain
...
//	Constant Equation Finite Volume
	{
		typedef FVConstantEquationElemDisc<domain_type, algebra_type> T;
...
bool RegisterConstantEquationDisc(Registry& reg, const char* parentGroup)
{
	typedef TDoFDistribution dof_distribution_type;
	typedef TAlgebra algebra_type;
	typedef typename algebra_type::vector_type vector_type;
	...
	//	Domain dependend part 1D
		{
			...
			RegisterConstantEquationObjects<domain_type, algebra_type, dof_distribution_type>(reg, grp.c_str());
		}
#endif
	...
	{
		UG_LOG("### ERROR in RegisterConstantEquationDiscs: "
...
bool RegisterDynamicConstantEquationDisc(Registry& reg, int algebra_type, const char* parentGroup)
{
	...
	switch(algebra_type)
	{
	case eCPUAlgebra:		 		bReturn &= RegisterConstantEquationDisc<CPUAlgebra, P1ConformDoFDistribution>(reg, parentGroup); break;
	case eCPUBlockAlgebra2x2: 		bReturn &= RegisterConstantEquationDisc<CPUBlockAlgebra<2>, GroupedP1ConformDoFDistribution>(reg, parentGroup); break;
//	case eCPUBlockAlgebra3x3: 		bReturn &= RegisterConstantEquationDisc<CPUBlockAlgebra<3>, GroupedP1ConformDoFDistribution>(reg, parentGroup); break;
//	case eCPUBlockAlgebra4x4: 		bReturn &= RegisterConstantEquationDisc<CPUBlockAlgebra<4>, GroupedP1ConformDoFDistribution>(reg, parentGroup); break;
//	case eCPUVariableBlockAlgebra: 	bReturn &= RegisterConstantEquationDisc<CPUVariableBlockAlgebra, GroupedP1ConformDoFDistribution>(reg, parentGroup); break;
