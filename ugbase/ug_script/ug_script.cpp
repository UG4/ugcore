...
/**
 * parses file and line of error occurrence and sets attributes file and line
 * @param msg lua error message generated by function lua_tostring(lua_State*, -1)
 */
LuaError::LuaError(const char* msg): UGError(msg) {
	std::string msg_(msg);

	size_t i = msg_.find_first_of(':');
	m_file = msg_.substr(0, i);
