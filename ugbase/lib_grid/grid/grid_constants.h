...
enum FaceOptions
{
	...
	FACEOPT_STORE_ASSOCIATED_EDGES = 0x00010000,
	FACEOPT_STORE_ASSOCIATED_VOLUMES = 0x00020000,
	//FACEOPT_STORE_ADJACENT_FACES = 0x00040000,
...
enum VolumeOptions
{
	...
	VOLOPT_STORE_ASSOCIATED_EDGES = 0x01000000,
	VOLOPT_STORE_ASSOCIATED_FACES = 0x02000000,
	//VOLOPT_STORE_ADJACENT_VOLUMES = 0x04000000,
...
enum GridOptions
{
	...
	GRIDOPT_DEFAULT = GRIDOPT_STANDARD_INTERCONNECTION
};
