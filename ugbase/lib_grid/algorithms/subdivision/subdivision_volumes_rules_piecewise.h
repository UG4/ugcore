...
#ifndef __H__UG__SUBDIVISION_VOLUMES_RULES__
#define __H__UG__SUBDIVISION_VOLUMES_RULES__
...
///	A singleton that stores all rules for a tet/oct subdivision volumes.
class SubdivRules_Volumes
{
	public:
		struct NeighborInfo{
			NeighborInfo()	{}
	...
	///	returns the only instance to this singleton.
		static SubdivRules_Volumes& inst()
		{
			static SubdivRules_Volumes subdivRules;
			return subdivRules;
		}
...
*/
	...
	///	private copy constructor prohibits copy-construction.
		SubdivRules_Volumes(const SubdivRules_Volumes& src);
