...
{
	public:
		static const byte_t ES_MAX = (ES_V_MASTER | ES_H_MASTER | ES_H_SLAVE | ES_V_SLAVE);
		static const byte_t SS_MAX = SurfaceView::ALL;

		static const int ALL_FCT = -1;
		static const int ALL_SUBSET = -1;
		static const byte_t ALL_ES = ES_MAX + 1;
		static const byte_t ALL_SS = SS_MAX + 1;
		static const byte_t UNIQUE_ES = ES_MAX + 2;
		static const byte_t UNIQUE_SS = SS_MAX + 2;

	protected:
		struct Cnt{

			Cnt();
			void add(uint64 num, SurfaceView::SurfaceState ss, byte_t is);
