...
#ifndef NWETON_SOLVER_ADAPTIVE_HPP
#define NWETON_SOLVER_ADAPTIVE_HPP
		...
		public DebugWritingObject<TAlgebra>
{
	...
	///	constructor setting operator
		explicit Newton_Solver_Adaptive(SmartPtr<IOperator<vector_type> > N);

	///	constructor using assembling
		explicit Newton_Solver_Adaptive(SmartPtr<IAssemble<TAlgebra> > spAss);
...
#include "newton_solver_adaptive_impl.hpp"

#endif //NWETON_SOLVER_ADAPTIVE_HPP
