...
//	todo: maybe remove this from interface
	...
	//	d.h. jedem DoF sein geometrisches Objekt zuweisen?! (Ÿber Array)
...
{
	/*	TODO: momentan wird zum Lšsen der komponentenweisen
	 ...
	 * 	(Sekantenverfahren, ect...) zur Lšsung dieser Teilprobleme
	 * 	aufgesetzt werden.-> Verallgemeinerung Ÿber set_nonlinear_solver? */
	...
	while(!m_spConvCheck->iteration_ended())
	{
		...
		for (size_t i = 0; i < n_indices; i++)
		{
			...
			// 	TODO: anstatt die ganzen EintrŠge zu durchlaufen,
			//	nur die Nachbarschaft einer Komponente in der nŠchsten Iteration abgrasen!
		}
