...
class ReferenceElement
{
	...
	/// returns the dimension where reference element lives
		[[nodiscard]] int dimension() const {return m_dim;}

	/// returns the size (e.g. area or volume) of the reference element
		[[nodiscard]] number size() const	{return m_size;}
	 ...
	 */
		[[nodiscard]] size_t num(int dim) const	{return m_vNum[dim];}
	 ...
	 */
		[[nodiscard]] size_t num(int dim_i, size_t i, int dim_j) const
	 ...
	 * 				contained in the i*th (sub-)geom object of dimension dim_i
	 */
		[[nodiscard]] int id(int dim_i, size_t i, int dim_j, size_t j) const
...
class DimReferenceElement : public ReferenceElement
{
	...
	/// coordinates of reference corner in a vector
		[[nodiscard]] const MathVector<dim>* corners() const {return &m_vCorner[0];}

	/// coordinates of reference corner (i = 0 ... num(0))
		[[nodiscard]] const MathVector<dim>& corner(size_t i) const {return m_vCorner[i];}

	/// coordinates of reference corner as integer
		[[nodiscard]] const MathVector<dim,int>* corner() const {return m_vCoInt;}
...
class ReferenceElementProvider
{
	...
	//	intentionally left unimplemented
		ReferenceElementProvider(const ReferenceElementProvider&)= default;
...
class ReferenceVertex : public DimReferenceElement<0>
{
	...
	/// \copydoc ug::ReferenceElement::size()
		[[nodiscard]] number size() const	{return 1.0;}
};
...
class ReferenceEdge : public DimReferenceElement<1>
{
	...
	/// \copydoc ug::ReferenceElement::size()
		[[nodiscard]] number size() const	{return 0.5;}
...
class ReferenceTetrahedron : public DimReferenceElement<3>
{
	...
	/// \copydoc ug::ReferenceElement::size()
		[[nodiscard]] number size() const	{return 1.0/6.0;}
...
class ReferenceOctahedron : public DimReferenceElement<3>
{
	...
	/// \copydoc ug::ReferenceElement::size()
		[[nodiscard]] number size() const	{return 2.0/3.0;}
