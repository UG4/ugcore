...
#ifndef __H__UG__LIB_DISC__TIME_DISCRETIZATION__PREVIOUS_SOLUTION__
#define __H__UG__LIB_DISC__TIME_DISCRETIZATION__PREVIOUS_SOLUTION__
...
#endif /* __H__UG__LIB_DISC__TIME_DISCRETIZATION__PREVIOUS_SOLUTION__ */
