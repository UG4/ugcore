...
#ifndef __H__UG__LIB_DISC__SPATIAL_DISCRETIZATION__ELEM_DISC__THERMOHALINE_FLOW__FV1__THERMOHALINE_FLOW__
#define __H__UG__LIB_DISC__SPATIAL_DISCRETIZATION__ELEM_DISC__THERMOHALINE_FLOW__FV1__THERMOHALINE_FLOW__
	...
	: public IDomainElemDisc<TDomain>
{
	...
	///	computes the value of the brine mass fraction
		template <typename TElem>
		bool ex_temperature(const local_vector_type& u,
						  const MathVector<dim> vGlobIP[],
						  const MathVector<FV1Geometry<TElem,dim>::dim> vLocIP[],
						  const size_t nip,
						  number vValue[],
	...
	///	computes the value of the gradient of the brine mass fraction
		template <typename TElem>
		bool ex_temperature_grad(const local_vector_type& u,
							   const MathVector<dim> vGlobIP[],
							   const MathVector<FV1Geometry<TElem,dim>::dim> vLocIP[],
							   const size_t nip,
							   MathVector<dim> vValue[],
...
#endif /*__H__UG__LIB_DISC__SPATIAL_DISCRETIZATION__ELEM_DISC__THERMOHALINE_FLOW__FV1__THERMOHALINE_FLOW__*/
