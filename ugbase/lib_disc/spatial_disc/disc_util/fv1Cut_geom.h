...
#define __H__UG__LIB_DISC__SPATIAL_DISC__DISC_HELPER__FV1CUT_GEOMETRY__
...
#include "lib_disc/spatial_disc/immersed_util/cut_element_handler/cut_element_handler.h"
...
//class InterfaceHandlerLocalDiffusion;
        
////////////////////////////////////////////////////////////////////////////////
// FV1Cut Geometry for Reference Element Type
////////////////////////////////////////////////////////////////////////////////
...
class FV1CutGeometry : public FVGeometryBase
{
	public:
	///	type of element
	 ...
	 */
		class SCVF
		{
			...
			// 	let outer class access private members
				friend class FV1CutGeometry<TElem, TWorldDim>;
 ...
 * \tparam	TWorldDim	(physical) world dimension
 */
template <int TDim, int TWorldDim, class TInterfaceHandler = InterfaceHandlerLocalDiffusion<TWorldDim> >
class DimFV1CutGeometry : public FVGeometryBase
{
	public:
	///	used traits
	 ...
	 */
		class SCVF
		{
			...
			private:
			// 	let outer class access private members
				friend class DimFV1CutGeometry<dim, worldDim, TInterfaceHandler>;
    ...
    /// called during 'ParticleBndCond::add_def_M_local()':
        const number volume_fem_elem() const {UG_THROW("FV1CutGeom::volume_fem_elem() not implemented!\n");}
...
*/
	...
	/// returns the boundary face i for subsetIndex
		inline const BF& bf(int si, size_t i) const
		{
			typename std::map<int, std::vector<BF> >::const_iterator it;
			it = m_mapVectorBF.find(si);
			if(it == m_mapVectorBF.end()) UG_THROW("DimFV1CutGeom: No BndSubset "<<si);
			return (*it).second[i];
		}
    ...
    // InterfaceHandlerLocalDiffusion: derived from class 'IInterfaceHandlerLocal'
