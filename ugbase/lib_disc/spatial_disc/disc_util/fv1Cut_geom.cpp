...
#define __H__UG__LIB_DISC__SPATIAL_DISC__DISC_HELPER__FV1Cut_GEOMETRY_IMPL_

#include "common/util/provider.h"
#include "fv1Cut_geom.h"
...
FV1CutGeometry<TElem, TWorldDim>::
FV1CutGeometry()
...
template <typename TElem, int TWorldDim>
void FV1CutGeometry<TElem, TWorldDim>::
update_local_data()
{
...
void DimFV1CutGeometry<TDim, TWorldDim,  TInterfaceHandler>::
...
//	get reference element
	...
	UG_CATCH_THROW("DimFV1CutGeometry: update failed.");
...
// corners 'vCornerCoords' in case of a cut element
   ...
   set_element_modus(false);
    ...
    m_spInterfaceHandler->clear_boundary_faces();
...
//       (INSIDE_DOM/OUTSIDE_DOM/CUT_BY_INTERFACE)
    ...
    UG_CATCH_THROW("DimFV1CutGeometry: access to InterfaceHander::update_elem() failed!.");
...
update_inner_boundary_faces()
{
    ...
    UG_CATCH_THROW("DimFV1CutGeometry: update_inner_boundary() failed.");
...
template class FV1CutGeometry<RegularEdge, 1>;
template class FV1CutGeometry<RegularEdge, 2>;
template class FV1CutGeometry<RegularEdge, 3>;

template class FV1CutGeometry<Triangle, 2>;
template class FV1CutGeometry<Triangle, 3>;

template class FV1CutGeometry<Quadrilateral, 2>;
template class FV1CutGeometry<Quadrilateral, 3>;

template class FV1CutGeometry<Tetrahedron, 3>;
template class FV1CutGeometry<Prism, 3>;
template class FV1CutGeometry<Pyramid, 3>;
template class FV1CutGeometry<Hexahedron, 3>;
template class FV1CutGeometry<Octahedron,3>;

//////////////////////
// DimFV1CutGeometry
template class DimFV1CutGeometry<1, 1, InterfaceHandlerLocalDiffusion<1> >;
    
template class DimFV1CutGeometry<2, 2, InterfaceHandlerLocalDiffusion<2> >;
    
template class DimFV1CutGeometry<3, 3, InterfaceHandlerLocalDiffusion<3> >;
    
    
} // end namespace ug

#endif /* __H__UG__LIB_DISC__SPATIAL_DISC__DISC_HELPER__FV1Cut_GEOMETRY_IMPL_ */
