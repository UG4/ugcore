...
--
--   Author: Josef Dubsky, Andreas Vogel - testwise solving with HLib arithmetic added (14032011ih)
--
-------------------------------------------------------------------
-- ugshell -ex ../scripts/navier_stokes_hlib.lua -numTotalRefs 0
--------------------------------
--------------------------------
-- Parameter setup
--------------------------------
...
dirichletBnd:add(ConstZeroDirichlet, "v", "Inlet,UpperWall,LowerWall,CylinderWall")
...
--linSolver = LU()
-- Test (14032011ih)
linSolver = HLIBSolver()
linSolver:set_hlib_accuracy_H(1.e-4)  -- default: 1.e-4
linSolver:set_hlib_accuracy_LU(5.e-1) -- default: 1.e-4
...
linSolver:set_clustering_method("algebraic", "nested dissection")

linSolver:set_hlib_verbosity(4) -- '>= 2': create HLIB related postscripts; '>=3' also create plots of matrix entries
linSolver:set_ps_basename("NS")
...
WriteGridFunctionToVTK(u, "NS-HLib-Solution")
