...
--
--	This is just a copy of the real tutorial found in scripts/tutorials.
--	Its purpose here is solely to demonstrate how a script-app should be
--	structured. Note that the domain is loaded from the folder sample_grids,
--	located in the scripts folder. This folder is specified relative to the
--	scripts directory and thus found automatically, no matter from where you
--	run the script.
--------------------------------------------------------------------------------
...
gridName = util.GetParam("-grid", "sample_grids/unit_square/unit_square_quads_8x8.ugx")
