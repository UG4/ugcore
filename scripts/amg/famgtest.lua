...
if bUseFAMG == 1 then
	...
	-- amg:set_debug_level_overlap(4)
	-- amg:set_debug_level_testvector_calc(4)
	-- amg:set_debug_level_phase_3(4)
	-- amg:set_debug_level_get_ratings(4)
	-- amg:set_debug_level_calculate_parent_pairs(4)
	-- amg:set_debug_level_coloring(4)
	-- amg:set_debug_level_recv_coarsening(4)
	-- amg:set_debug_level_precalculate_coarsening(4)
	-- amg:set_debug_level_aggressive_coarsening(4)
	-- amg:set_debug_level_send_coarsening(4)
	-- amg:set_debug_level_communicate_prolongation(4)
	-- amg:set_debug_level_after_communciate_prolongation(4)
else
	print ("create AMG... ")
